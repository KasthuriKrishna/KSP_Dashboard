...
const [file, setFile] = useState(null);
  ...
  return (
    <div>
    <h2>ADD NEW FIR</h2>
    <h4>Sample input values are also provided</h4>
    ...
    <label htmlFor="District_Name">District Name:--(Bengaluru Dist)</label>
...
<div className="form-field">
  <label htmlFor="Month">Month:--(3)</label>
...
<div className="form-field">
    <label htmlFor="FIR_start_date">FIR Date:--(autofill)</label>
    <input
      type="text"
      id="FIR_start_date"
      name="FIR_start_date"
...
<div className="form-field">
  <label htmlFor="FIR_Stage">FIR Stage:--(Traced,Pending...)</label>
...
<div className="form-field">
  <label htmlFor="CrimeGroup_Name">CrimeGroup Name:--(MURDER)</label>
  <input type="text" id="CrimeGroup_Name" name="CrimeGroup_Name" value={formData.CrimeGroup_Name} onChange={handleChange} />
</div>
<div className="form-field">
  <label htmlFor="CrimeHead_Name">CrimeHead Name:--(Name)</label>
...
<div className="form-field">
  <label htmlFor="Internal_IO">Internal IO:--(377700027)</label>
...
<div className="form-field">
  <label htmlFor="Distance_from_PS">Distance from PS:--(1 km)</label>
...
<div className="form-field">
<label htmlFor="Accused_ChargeSheeted_Count">Accused ChargeSheeted Count:--(1)</label>
...
<div className="form-field">
<label htmlFor="Conviction_Count">Conviction Count:--(0)</label>
...
<div className="form-field">
<label htmlFor="Crime_No">Crime No:--(1224)</label>
